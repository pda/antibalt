...
(function() {
  ...
  Gun = (function() {
    ...
    function Gun(view, objects, crosshair) {
      ...
      this.touch_listener = __bind(this.touch_listener, this);
    }

    Gun.prototype.bind_to_view = function() {
      this.view.canvas.addEventListener("click", this.click_listener);
      this.view.canvas.addEventListener("mousemove", this.mouse_move_listener);
      return this.view.canvas.ontouchstart = this.touch_listener;
    };
    ...
    Gun.prototype.touch_listener = function(event) {
      this.click_listener(event.touches[0]);
      return false;
    };

    Gun.prototype.click_listener = function(event) {
      var point;
      point = this.view.view_to_world(event.clientX, event.clientY);
  ...
  GarbageCollector = (function(_super) {
    ...
    GarbageCollector.prototype.execute = function() {
      ...
      return _.chain(this.objects).map(function(o, i) {
        if (o.should_gc && o.should_gc(_this.view)) {
          return i;
        }
      }).filter(function(i) {
        return i != null;
  ...
  GamePhysics = (function() {
    ...
    GamePhysics.prototype.apply_to_object = function(o, objects, seconds_elapsed) {
      if (o.velocity) {
        Physics.apply_x_velocity(o, seconds_elapsed);
      }
      if (o.platformable) {
        game_physics.splat_detection(o, objects);
      }
      if (o.gravity) {
        Physics.apply_gravity(o, seconds_elapsed);
      }
      if (o.velocity) {
        Physics.apply_y_velocity(o, seconds_elapsed);
      }
      if (o.platformable) {
        return game_physics.platform_detection(o, objects);
      }
    };
